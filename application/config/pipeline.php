...
return function (Application $app, MiddlewareFactory $factory, ContainerInterface $container): void{
	...
	//
	$app->pipe(\Towersystems\Talink\Middleware\InvalidTokenMiddleware::class);

	// Register all "resources"
	// these needs to be added *before* routes otherwise they will not be injected
	$app->pipe(\ResourceBundle\Middleware\ResourceRegistryMiddleware::class);
	$app->pipe(\ResourceBundle\Middleware\ResourceItemRegisterMiddleware::class);
	$app->pipe(\ResourceBundle\Middleware\ResourceLoaderMiddleware::class);
